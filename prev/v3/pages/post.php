...
<label id="Recruiter_Name">Recruiter ID</label> <input class="text" id ="recruiter_name" name="recruiter_name" type="text" value="<?php echo $_SESSION['user_name'];?>" readonly/><br/>
