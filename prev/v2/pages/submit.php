...
$myfile = fopen("jobsposted/".$filename.".xml", "w") or die("Unable to open file!");
$post = "
<job>
<req>$req</req>
<name>$name</name>
...
$myfile = fopen("careersite/".$filename."BoardA.html", "w") or die("Unable to open file!");
...
<p>$jobbenefits</p>
<form action=\"../responses/BoardA/response.html\">
...
<responseemail>$responseemail</responseemail>
	...
	$myfile = fopen("careersite/".$filename."BoardB.html", "w") or die("Unable to open file!");
$template="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
<html xmlns=\"http://www.w3.org/1999/xhtml\">
...
<label id=\"Jobbenefits\"><u><b>Job Benefits Description :</b></u></label>
<p>$jobbenefits</p>
<form action=\"../responses/BoardB/response.html\">
    <input type=\"submit\" value=\"Apply\">
</form>
</div>
...
<responseemail>$responseemail</responseemail>
	...
	$myfile = fopen("careersite/".$filename."BoardC.html", "w") or die("Unable to open file!");
$template="<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
<html xmlns=\"http://www.w3.org/1999/xhtml\">
...
<label id=\"Jobbenefits\"><u><b>Job Benefits Description :</b></u></label>
<p>$jobbenefits</p>
<form action=\"../responses/BoardC/response.html\">
    <input type=\"submit\" value=\"Apply\">
</form>
</div>
